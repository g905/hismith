...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        parseNews: function parseNews() {
            ...
            axios.get('/api/parse_news').then(function (response) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Parse News")]),
      _vm._v(" "),
      _c(
        "button",
        {
          ...
          on: { click: _vm.parseNews }
        },
        [_vm._v("Make new request")]
      ),
      _vm._v(" "),
      _vm.result
        ? _c("div", [
            _vm._v(
              "Request " + _vm._s(_vm.result.success ? "successful" : "failed")
            )
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm.result
        ? _c("div", [_vm._v("Added " + _vm._s(_vm.result.count) + " items")])
        : _vm._e()
    ],
    1
  )
